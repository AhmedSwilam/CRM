...
public class ContractTypeResponseCrm implements Serializable
{
    ...
    @SerializedName("Data")
    @Expose
    private List<DatumContract> data = null;
    ...
    private final static long serialVersionUID = -7835430350323049790L;
    ...
    public List<DatumContract> getData() {
        return data;
    }

    public void setData(List<DatumContract> data) {
        this.data = data;
    }
