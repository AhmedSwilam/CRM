...
public class EditProfileResponse implements Serializable
{
    ...
    @SerializedName("DataEditProfile")
    @Expose
    private DataEditProfile dataEditProfile;
    ...
    private final static long serialVersionUID = 2396072377678138685L;
    ...
    public void setData(DataEditProfile dataEditProfile) {
        this.dataEditProfile = dataEditProfile;
    }
