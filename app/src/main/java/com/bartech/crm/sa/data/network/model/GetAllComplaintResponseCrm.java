...
public class GetAllComplaintResponseCrm implements Serializable
{
    ...
    @SerializedName("Data")
    @Expose
    private List<DatumGetAllRequests> data = null;
    ...
    private final static long serialVersionUID = 2303489012606793673L;
    ...
    public List<DatumGetAllRequests> getData() {
        return data;
    }

    public void setData(List<DatumGetAllRequests> data) {
        this.data = data;
    }
