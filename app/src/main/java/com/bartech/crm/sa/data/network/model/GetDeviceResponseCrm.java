...
public class GetDeviceResponseCrm implements Serializable
{
    ...
    @SerializedName("Data")
    @Expose
    private List<DatumDevice> data = null;
    ...
    private final static long serialVersionUID = 6127034911910755643L;
    ...
    public List<DatumDevice> getData() {
        return data;
    }

    public void setData(List<DatumDevice> data) {
        this.data = data;
    }
