...
public class ProblemTypeResponseCrm implements Serializable
{
    ...
    @SerializedName("Data")
    @Expose
    private List<DatumProblem> data = null;
    ...
    private final static long serialVersionUID = 1560819787573856888L;
    ...
    public List<DatumProblem> getData() {
        return data;
    }

    public void setData(List<DatumProblem> data) {
        this.data = data;
    }
